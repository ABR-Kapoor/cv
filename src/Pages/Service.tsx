...
const Services: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen pt-20 sm:pt-32 pb-10 sm:pb-20 px-2 sm:px-4 flex flex-col items-center justify-start overflow-x-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
      ...
      <motion.p
        className="relative z-10 max-w-xs sm:max-w-2xl mx-auto text-sm sm:text-base md:text-lg text-center mb-2 sm:mb-6 text-gray-300"
      ...
      <motion.h2
        className="relative z-10 text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-4 text-center text-cyan-200"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
