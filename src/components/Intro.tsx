    ...
    <div className="[perspective:900px]">
      ...
      >
        ...
        <motion.img
          src={profilePic}
          alt="Abeer Kapoor"
          className="hero-photo relative z-10 rounded-full object-cover border-2 border-white/80"
          style={{
...
const Intro = () => (
  <section className="relative min-h-[100svh] lg:min-h-screen flex items-center justify-center overflow-hidden px-4 pt-24 sm:pt-20 pb-16 sm:pb-12">
    {/* Ambient background */}
    ...
    <div className="relative z-10 w-full max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
        ...
        <div className="flex flex-col gap-5 sm:gap-6 text-center lg:text-left items-center lg:items-start">
          ...
          <motion.p
            ...
            style={{ fontSize: "clamp(0.98rem, 4.2vw, 1.3rem)", color: "var(--text-secondary)" }}
          ...
          {/* Stats row */}
          <motion.div
            className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2 w-full"
            initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
          ...
          {/* CTA row */}
          <motion.div
            className="flex flex-col sm:flex-row sm:flex-wrap gap-3 pt-1 w-full max-w-xl"
            initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.7, duration: 0.5 }}
          >
            <a href={RESUME} onClick={handleDownload} className="btn-primary w-full sm:w-auto justify-center">
      ...
      <motion.div
        className="hidden sm:flex absolute bottom-0 left-1/2 -translate-x-1/2 flex-col items-center gap-1.5"
